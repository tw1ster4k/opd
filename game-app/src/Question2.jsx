...
const questions = [
  { question: "Что считать в чужом кармане нехорошо, но очень интересно?", answer: "Деньги" },
  { question: "Делать это ни в чужом, ни тем паче в своём доме не стоит: деньгу выжить можно", answer: "Свистеть" },
  ...
  { question: "Какой песенный остров весь покрыт американской валютой?", answer: "Остров невезения" },
  { question: "Верно ли, что финансовыми воротилами называют тех, кого воротит от денег?", answer: "Нет, это те, кто ворочает деньгами" },
  { question: "Как называется ожерелье из монет?", answer: "Монисто" },
  { question: "И марка российского самолёта, и вьетнамская копейка.", answer: "СУ" },
];
